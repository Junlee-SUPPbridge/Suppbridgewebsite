...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'SuppBridge', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Providing flexible supply chain solutions for innovative nutrition brands worldwide', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.suppbridge.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'supplement supply chain, product formulation, raw material sourcing, manufacturer matching, logistics customs, nutrition brands', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Hi, welcome to SuppBridge. We provide flexible supply chain solutions for innovative nutrition brands worldwide.',
